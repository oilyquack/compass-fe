  ...
  return (
    <Section>
      ...
      <dl className={`font-family-lato ${styles.FaqsPage}`}>
        ...
        <Answer>
          Your One Day or Two-Day ticket is exchanged for a festival wristband,
          which gives you access to all shows in all venues for the day or days
          you choose. Access is subject to each venue’s capacity.
        </Answer>
        ...
        <Answer>
          ...
          Saturday), and bands will be alternating sets so there will always be
          something for you to go and watch!
        </Answer>
        ...
        <Answer>
          U18s (14+) must be with an adult, and most venues will only allow them
          to stay until 9pm to comply with their license. We’d love to have
          younger audiences still, but it adds an extra layer we cannot sustain
        ...
        <Answer>
          ...
          costs, as we only receive minimal project local funding, which is also
          down 20% this year from last year!
          <br />
        ...
        <Answer>
          Possibly — but only if not sold out. Buying early helps us survive and
          reduces risk for grassroots festivals like ours.
          <br />
